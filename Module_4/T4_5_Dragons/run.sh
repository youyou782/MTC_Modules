...
MODULE=Module_4
EXERCISE=T4_5_Dragons
SRC_DIR=src
SOLUTION_FILES=("dragon_cave.hpp" "dragon_cave.cpp" "dragon.hpp" "dragon.cpp" "fantasy_dragon.hpp" "fantasy_dragon.cpp" "magic_dragon.hpp" "magic_dragon.cpp")
SUPPLEMENTARY_FILES=()
